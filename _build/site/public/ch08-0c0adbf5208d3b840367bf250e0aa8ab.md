...
We can solve the logistic differential equation (Eq. :ref:`eq:08.01`) using variable transformations. First, introduce the change of variable $x = 1/N$. This transforms Eq. :eq:`eq:08.01` to:
$$
