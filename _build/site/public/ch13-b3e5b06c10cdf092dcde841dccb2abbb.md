...
The previous analysis reveals four possible long-term scenarios based on the competition coefficients $a_{12}$ and $a_{21}$, as illustrated in Fig. :numref:`fig:13.01`:
...
2. When $a_{12}$ and $a_{21}$ are both less than 1, $E_4$ represents the sole steady state. Here, interspecific competition is weak enough to allow the long-term coexistence of both species for most initial conditions.
    1. Finally, if $a_{12}$ and $a_{21}$ both exceed 1, the extinction equilibria $E_2$ and $E_3$ become stable, creating a bistable system. In this case, the phase plane separates into two basins of attraction defined by a separatrix running through $E_1$ and $E_4$. Populations beginning in either basin asymptotically approach either the $E_2$ or $E_3$ equilibrium exclusively.
...
$$
    ...
    1. Consider the following model of integration through competition: 
    $$
