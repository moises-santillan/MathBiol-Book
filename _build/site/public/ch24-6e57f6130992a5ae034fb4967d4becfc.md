...
$$
K_D = n \frac{[\text{L}]\overline{[\text{R}]}}{\overline{[\text{R}_L]}} = \frac{n-1}{2} K_A \frac{[\text{L}]\overline{[\text{R}_L]}}{{[\text{R}_{2L}]}} = \cdots = \frac{1}{n} K_A^{n(n-1)/2} \frac{[\text{L}][\text{R}_{(n-1)L}]}{[\text{R}_{nL}]}.
$$
