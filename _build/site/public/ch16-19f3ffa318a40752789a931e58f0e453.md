...
The herd immunity threshold ($p_c$) is the fraction of the population that must be immune ($1 - \eta$) to satisfy this condition. We define $p$ as the immune/recovered fraction ($1 - \eta$):
