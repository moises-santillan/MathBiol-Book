...
The tryptophan operon is involved in the biosynthesis of the tryptophan amino acid in bacteria such as Escherichia coli and Salmonella typhimurium. This operon contains five structural genes (*trpE*, *trpD}, \emph{trpC}, \emph{trpB}, and \emph{trpA}) that encode the enzymes necessary for the synthesis of tryptophan from a precursor called chorismate.
