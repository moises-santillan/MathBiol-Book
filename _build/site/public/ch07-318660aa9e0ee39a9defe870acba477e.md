# On the Interconnected Origins of Statistics, Probability Theory and Population Dynamics {#ch:07}
...
The key sources that informed the development of this chapter were the following works :cite:`\1`. Readers interested in exploring these topics in more depth are encouraged to refer to these publications.
