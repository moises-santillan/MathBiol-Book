...
If the fraction of succeptible individuals is higher than $1/R_0$, the population is in a sub-critical state (prone to outbreaks). If it is lower, the population has reached herd immunity**.
