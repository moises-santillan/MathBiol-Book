...
```{figure} Figures/fig-13.01.A.pdf
:name: fig:13.01

Qualitative behavior of the competitive Lotka-Volterra model in the four regimes defined by the competition coefficients $a_{12}
```
