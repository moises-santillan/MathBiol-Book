...
2. Increase removal rate ($\delta$). In agricultural or wildlife settings, humane culling of visibly infected individuals can effectively increase the disease-induced mortality rate parameter $\delta$. However, in human populations a more ethical approach is to quickly identify infectious individuals through widespread testing and rigorous contact tracing and place them in isolation.
