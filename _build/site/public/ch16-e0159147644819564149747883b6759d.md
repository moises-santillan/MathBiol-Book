...
* If $\eta < 1/R_0$: The population has reached herd immunity. Even if an infected person enters the population, they will, on average, encounter so many immune individuals that they will infect fewer than one person before recovering. The "spark" of infection fails to catch fire.In summary, $\eta$ is the "fuel" available for the epidemic. If the fuel level is below the inverse of the disease's "burn rate" ($1/R_0$), the fire cannot be sustained.
