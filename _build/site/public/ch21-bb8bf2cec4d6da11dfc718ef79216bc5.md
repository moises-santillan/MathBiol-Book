...
We begin by considering an RC low-pass filter, whose circuit is illustrated in Fig. :numref:`fig:filter_circuit`. The filter contains a resistor R and a capacitor C connected in series.
