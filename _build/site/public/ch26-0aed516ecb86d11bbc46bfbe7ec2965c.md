...
2. **Rho ($\rho$)-mediated Transcription Termination** - The Rho protein can bind to the *tnaC* leader sequence and prematurely terminate transcription of *tnaA* and *tnaB*. However, this termination is suppressed when tryptophan is present in the cytoplasm due to ribosome stalling on the *tnaC* transcript.
3. **Post-translational Regulation of TnaA** - The TnaA enzyme is initially produced in an inactive form clustered into foci. In the stationary phase, these foci disperse and TnaA becomes an active tetrameric enzyme that can metabolize tryptophan. This activation is regulated by an unknown cAMP-CAP independent mechanism related to glucose levels.
