# Local Stability Analysis {#ch:06}
...
Consider the function $f(x)$ depicted in Fig. :numref:`fig:06.01`. Two roots, denoted $x_1$ and $x_2$, of the equation $f(x)=0$ are evident. Consequently, these locations define the steady states of the differential equation $dx/dt=f(x)$.

```{figure} Figures/fig-06.01.pdf
:name: fig:06.01
---
