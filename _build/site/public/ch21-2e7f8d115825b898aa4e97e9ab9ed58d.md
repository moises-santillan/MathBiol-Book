# 21. Quasisteady State Approximation
...
$$
\frac{dx}{dt}  = \alpha(f(y) - x), \quad \frac{dy}{dt}  = \beta(g(x) - y).
$$
...
$$\begin{align*\lambda_1 = - \frac{\gamma + 1}{2} + \frac{\sqrt{(\gamma + 1)^2 - 4 \gamma (1 - f'(y^*)g'(x^*))}}{2},
$$
