...
The tryptophanase (t\texti{tna}) operon in \textit{Escherichia coli} encodes the proteins necessary for uptake and metabolism of the amino acid tryptophan as a carbon source in the absence of glucose. The \textit{tna} operon consists of two structural genes: \textit{tnaA} and \textit{tnaB}.
