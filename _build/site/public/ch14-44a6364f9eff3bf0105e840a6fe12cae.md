...
1. Upon infection, individuals immediately become infectious.
1. Transmission occurs through contact between susceptible and infected individuals. The rate of new infections is thus proportional to both the number of susceptible ($S$) and infected ($I$) individuals, with proportionality constant $\beta$ known as the transmission rate.
1. Infected individuals recover at a constant rate $\gamma$ and acquire lifelong immunity.
1. The population birth rate is constant and denoted by $\alpha$.
1. Individuals in all compartments die due to causes other than disease at constant rate $\mu$, and infected individuals also die due to causes directly associated to the disease at a constant rate $\delta$.

```{figure} Figures/fig-14.01.pdf
:name: fig:14.01
---
