...
Here, the parameter $\eta \in [0, 1]$ represents the initial "fraction of vulnerability"—the proportion of the population that is susceptible when the disease is introduced.



### Stability and the Epidemic Threshold
