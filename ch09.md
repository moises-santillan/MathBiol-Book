...
2. Transcritical bifurcation: a stable and unstable fixed point exchange stability at the critical parameter value.
3. Pitchfork bifurcation: a single fixed point loses stability, splitting into three solutions of which two are stable.
