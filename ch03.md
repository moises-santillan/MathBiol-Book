...
In this chapter we briefly review their history. For those seeking a deeper understanding of the history of logarithmic and exponential functions, the \emph{History of the Exponential and Logarithmic Concepts} series of articles, published in 1913 in the American Mathematical Monthly: {cite}`Cajori1913a`, {cite}`Cajori1913b`, {cite}`Cajori1913c`, {cite}`Cajori1913d`, {cite}`Cajori1913e`, {cite}`Cajori1913f`, {cite}`Cajori1913g`.
